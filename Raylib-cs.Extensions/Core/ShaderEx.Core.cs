...
public static class ShaderEx
{
    ...
    /// </summary>
    public static void BeginMode(this Shader shader)
    {
    ...
    /// </summary>
    public static void EndMode(this Shader shader)
    {
    ...
    /// </summary>
    public static bool IsReady(this Shader shader)
    {
    ...
    /// </summary>
    public static void SetValue<T>(this Shader shader, ShaderLocationIndex index, Span<T> values,
    ...
    ///     Set shader uniform value vector
    /// </summary>
    public static unsafe void SetValue<T>(this Shader shader, ShaderLocationIndex index, T* values,
        ShaderUniformDataType type)
        where T : unmanaged
    {
        Raylib.SetShaderValue(shader, (int)index, values, type);
    ...
    /// </summary>
    public static void Unload(this Shader shader)
    {
