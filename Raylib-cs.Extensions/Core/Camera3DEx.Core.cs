...
public static partial class Camera3DEx
{
    ...
    /// </summary>
    public static void BeginMode(this Camera3D camera)
    {
    ...
    /// </summary>
    public static void EndMode(this Camera3D camera)
    {
        Raylib.EndMode3D();
    }
    ...
    /// </summary>
    public static void Update(this ref Camera3D camera, CameraMode mode)
    {
        Raylib.UpdateCamera(ref camera, mode);
    }
    ...
    public static unsafe Vector3 GetForward(this ref Camera3D camera)
    {
        ...
        {
            return Raylib.GetCameraForward(ptr);
        }
    }
    ...
    public static unsafe Vector3 GetRight(this ref Camera3D camera)
    {
        fixed (Camera3D* ptr = &camera)
        {
            return Raylib.GetCameraRight(ptr);
        }
    }
    ...
    public static unsafe void MoveForward(this ref Camera3D camera, float distance, bool inWorldPlane)
    {
        fixed (Camera3D* ptr = &camera)
        {
            Raylib.CameraMoveForward(ptr, distance, inWorldPlane);
        }
    }
    ...
    public static unsafe void MoveRight(this ref Camera3D camera, float distance, bool inWorldPlane)
    {
        fixed (Camera3D* ptr = &camera)
        {
            Raylib.CameraMoveRight(ptr, distance, inWorldPlane);
        }
    }
    ...
    public static unsafe void MoveUp(this ref Camera3D camera, float distance)
    {
        fixed (Camera3D* ptr = &camera)
        {
            Raylib.CameraMoveUp(ptr, distance);
        }
    }
    ...
    public static unsafe void MoveToTarget(this ref Camera3D camera, float delta)
    {
        fixed (Camera3D* ptr = &camera)
        {
            Raylib.CameraMoveToTarget(ptr, delta);
        }
    }
    ...
    /// </summary>
    public static unsafe void RotateYaw(this ref Camera3D camera, float angle, bool rotateAroundTarget,
        bool useDegrees = false)
    {
        fixed (Camera3D* ptr = &camera)
        {
            Raylib.CameraYaw(ptr, useDegrees ? angle * Raylib.DEG2RAD : angle, rotateAroundTarget);
        }
    }
    ...
    ///     - rotateUp rotates the up direction as well (typically only usefull in Free) <br />
    ///     NOTE: angle must be provided in radians (set 'useDegrees' to 'true' if you use degrees)
    /// </summary>
    public static unsafe void RotatePitch(this ref Camera3D camera, float angle, bool lockView, bool rotateAroundTarget,
        bool rotateUp, bool useDegrees = false)
    {
        fixed (Camera3D* ptr = &camera)
        {
            Raylib.CameraPitch(ptr, useDegrees ? angle * Raylib.DEG2RAD : angle, lockView, rotateAroundTarget,
                rotateUp);
        }
    }
    ...
    public static unsafe void RotateRoll(this ref Camera3D camera, float angle, bool useDegrees = false)
    {
        fixed (Camera3D* ptr = &camera)
        {
            Raylib.CameraRoll(ptr, useDegrees ? angle * Raylib.DEG2RAD : angle);
        }
    }
    ...
    public static unsafe Matrix4x4 GetViewMatrix(this ref Camera3D camera)
    {
        fixed (Camera3D* ptr = &camera)
        {
            return Raylib.GetCameraViewMatrix(ptr);
        }
    }
    ...
    public static unsafe Matrix4x4 GetProjectionMatrix(this ref Camera3D camera)
    {
        fixed (Camera3D* ptr = &camera)
        {
            return Raylib.GetCameraProjectionMatrix(ptr, (float)Raylib.GetScreenWidth() / Raylib.GetScreenHeight());
        }
    }
    ...
    public static unsafe Matrix4x4 GetProjectionMatrix(this ref Camera3D camera, float aspect)
    {
        fixed (Camera3D* ptr = &camera)
        {
            return Raylib.GetCameraProjectionMatrix(ptr, aspect);
        }
    }
}