...
public static class RayEx
{
    ...
    /// </summary>
    public static RayCollision GetRayCollisionMesh(this Ray ray, Mesh mesh, Matrix4x4 transform,
        bool transposeTransform = true)
    {
        return Raylib.GetRayCollisionMesh(ray, mesh, transposeTransform ? Matrix4x4.Transpose(transform) : transform);
    }
    ...
    {
        return Raylib.GetRayCollisionTriangle(ray, v1, v2, v3);
    }
