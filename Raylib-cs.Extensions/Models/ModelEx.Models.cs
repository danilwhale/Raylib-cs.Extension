...
public static partial class ModelEx
{
    ...
    /// </summary>
    public static bool IsReady(this Model model)
    {
        return Raylib.IsModelReady(model);
    }

    /// <summary>
    ///     Unload model (including meshes) from memory (RAM and/or VRAM)
    /// </summary>
    public static void Unload(this Model model)
    {
    ...
    /// </summary>
    public static void Draw(this Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle,
    ...
    /// </summary>
    public static void DrawWires(this Model model, Vector3 position, Vector3 rotationAxis, float rotationAngle,
        Vector3 scale, Color tint)
    {
